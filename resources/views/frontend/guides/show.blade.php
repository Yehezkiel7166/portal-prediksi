...
<section class="bg-slate-950"><div class="mx-auto max-w-5xl px-4 py-12"><article class="rounded-2xl border border-slate-800 bg-slate-900 p-6 md:p-8"><div class="prose prose-invert max-w-none break-words leading-8">{!! $guide->content !!}</div></article></div></section>
@endsection
